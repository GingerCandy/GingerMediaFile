...
bot.start(async(ctx)=>{
    ...
    if(length == 1){
        ctx.reply(`Saya akan menyimpan file untuk Anda dan memberikan tautan yang dapat dibagikan, saya juga dapat membuat file tersedia untuk semua pengguna. Mendukung <a href="https://t.me/mdtohtmlbot">HTML</a>.`,{
            parse_mode:'HTML'
            reply_markup:{
                inline_keyboard:[
