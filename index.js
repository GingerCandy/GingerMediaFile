    ...
    if(ctx.from.id ==process.env.ADMIN){
        ...
        if(length == 1){
            ...
            if (!profile || profile.total_count == 0)
                return ctx.reply(`${ctx.from.first_name} \n\nSaya akan menyimpan file untuk Anda dan memberikan tautan yang dapat dibagikan, saya juga dapat membuat file tersedia untuk semua pengguna. Bot mendukung pencarian dan myData() <a href="t.me/mdtohtmlbot">HTML</a>.`,{
                parse_mode:'HTML',
                reply_markup:{
                   inline_keyboard:[
